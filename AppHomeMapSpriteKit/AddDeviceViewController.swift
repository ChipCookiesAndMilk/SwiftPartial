...
class AddDeviceViewController: UITableViewController, HMAccessoryBrowserDelegate {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        Timer.scheduledTimer(timeInterval: 10.0, target: self, selector: #selector(AddDeviceViewController.stopSearching), userInfo: nil, repeats: false)
    }
